...
use HandlebarsHelpers\Sass\Formatter;
...
class Compiler {
    ...
    protected function newFormatter() {
        $className = "\HandlebarsHelpers\Less\FormatterLessJS";
        if (!empty($this->formatterName)) {
            if (!is_string($this->formatterName))
                return $this->formatterName;
            $className = "\HandlebarsHelpers\Less\Formatter".ucwords($this->formatterName);
        }
